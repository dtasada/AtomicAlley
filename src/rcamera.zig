...
pub fn moveRight(camera: *rl.Camera, distance: f32, moveInWorldPlane: bool) void {
...
pub fn moveUp(camera: *rl.Camera, distance: f32) void {
...
pub fn moveForward(camera: *rl.Camera, distance: f32, moveInWorldPlane: bool) void {
...
pub fn moveToTarget(camera: *rl.Camera, delta: f32) void {
